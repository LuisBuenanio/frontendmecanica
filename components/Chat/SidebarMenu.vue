  ...
  <div class="side-menu flex-lg-column me-lg-1 ms-lg-0">
      ...
      <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
        ...
        <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="javascript:void(0)" @click="Logout()">Log out <i
    ...
    <div class="flex-lg-column d-none d-lg-block">
      <ul class="nav side-menu-nav justify-content-center">
        <li class="nav-item">
          <a class="nav-link light-dark-mode" href="#" @click="dark()" data-bs-toggle="tooltip" data-bs-trigger="hover"
        ...
        <li class="nav-item btn-group dropup profile-user-dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">
            <div class="chat-user-img align-self-center" style="
    left: 10px;
">
              <div class="avatar-xs">
...
export default {
  ...
  methods: {
    Logout() {
      ...
      if (user != null) {
        this.$socket.main.emit("destroyUser", user)
      }
    ...
    dark() {
      ...
      if (this.isDark == true) {
        this.isDark = false
        b.setAttribute("data-layout-mode", "");
      } else {
        this.isDark = true

        b.setAttribute("data-layout-mode", "dark");
      }
    }
  },
